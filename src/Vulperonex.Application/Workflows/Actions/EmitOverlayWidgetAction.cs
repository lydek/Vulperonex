...
public sealed record EmitOverlayWidgetAction : WorkflowAction
{
    ...
    [ActionParam("Overlay Target", "string", required: false, help: "Target overlay screen identifier")]
    ...
    [ActionParam("Severity", "string", required: false, help: "Severity level of the alert, e.g. info, warning")]
