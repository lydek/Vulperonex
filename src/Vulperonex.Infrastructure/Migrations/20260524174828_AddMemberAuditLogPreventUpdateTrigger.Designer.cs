...
namespace Vulperonex.Infrastructure.Migrations
{
    ...
    [Migration("20260524174828_AddMemberAuditLogPreventUpdateTrigger")]
    partial class AddMemberAuditLogPreventUpdateTrigger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vulperonex.Infrastructure.Data.Entities.PlatformIdentityEntity", b =>
                {
                    ...
                    b.ToTable("PlatformIdentities", (string)null);
                });
            ...
            modelBuilder.Entity("Vulperonex.Infrastructure.Data.Entities.PlatformUserDisplayInfoEntity", b =>
                {
                    ...
                    b.Property<long>("TotalBitsGiven")
                        .HasColumnType("INTEGER");

                    b.HasKey("Platform", "PlatformUserId");

                    b.ToTable("PlatformUserDisplayInfo", (string)null);
                });
            ...
            modelBuilder.Entity("Vulperonex.Infrastructure.Data.Entities.TransientDeliveryQueueEntity", b =>
                {
                    ...
                    b.ToTable("TransientDeliveryQueue", (string)null);
                });
            ...
            modelBuilder.Entity("Vulperonex.Infrastructure.Data.Entities.WorkflowRuleEntity", b =>
                {
                    ...
                    b.Property<string>("OnFailureActionsJson")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Vulperonex.Infrastructure.Data.Entities.WorkflowTimerEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("WorkflowTimers", (string)null);
                });

            modelBuilder.Entity("Vulperonex.Infrastructure.Data.Entities.PlatformIdentityEntity", b =>
                {
                    b.HasOne("Vulperonex.Infrastructure.Data.Entities.MemberEntity", null)
                        .WithMany()
