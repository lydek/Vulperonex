...
- [ ] Phase 5 CLI REPL 補充：命令樹、`help`、Twitch auth status API、最小 REPL、no-Twitch mode banner、REPL 內 `twitch auth start` 缺 ClientId 保護已完成；Ctrl+C cancellation、TTY line editor、人工 terminal 驗證待完成
